...
public class Menu_Gamefinish : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Next.SetActive(GlobalValue.levelPlaying < GlobalValue.totalLevels);
    }
    ...
    IEnumerator Start()
    {
        ...
        ScrollHolder.SetActive(GameManager.Instance.levelType == LEVELTYPE.Normal);
        BossHolder.SetActive(GameManager.Instance.levelType == LEVELTYPE.BossFight);
        ...
        if (GameManager.Instance.levelType == LEVELTYPE.Normal)
        {
