...
public class SoundManager : MonoBehaviour {
    ...
    public AudioClip musicWorldChoose;
    ...
    public AudioClip soundRewardedChest;
    ...
    {
        PlaySfx(Instance.soundTutorial, 1); ;
    }

    public static void ShowRewardedChest()
    {
        PlaySfx(Instance.soundRewardedChest, 1); ;
    }
