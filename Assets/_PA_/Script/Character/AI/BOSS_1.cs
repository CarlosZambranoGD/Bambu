...
public class BOSS_1 : BossManager, ICanTakeDamage, IListener
{
   ...
   [ReadOnly] public bool isMeleeAttacking = false;
    ...
    [HideInInspector] public AudioClip disappearSound;
    [HideInInspector] public Transform disappearPointGroup;
    ...
    #region SPEED ATTACK
    [HideInInspector] public AudioClip speedAttackSound;
    [HideInInspector] public GameObject speedAttackHitPlayerFX;
    [HideInInspector] public float speedAttackTime = 3;
    [HideInInspector] public float Speed = 5f;
    [HideInInspector] public bool speedAttackUseGhostFX = true;
    ...
    #region SUPER ATTACK
    //[Header("Super Attack")]
    [HideInInspector] public bool useWaveAnimation = true;
    [HideInInspector] public GameObject SuperAttackBullet;
    [HideInInspector] public float delayPerAttack = 1.5f;
    [HideInInspector] public int attackTimes = 5;
    [HideInInspector] public AudioClip superAttackSound;
    ...
    [Range(3, 8)]
    [HideInInspector] public int numberBulletFA = 4;
    [HideInInspector] public float delayFA = 1;
    [HideInInspector] public float speedFA = 30;
    [HideInInspector] public float spaceFA = 2;
    [HideInInspector] public float distancePlayerHeadFA = 5;
    [HideInInspector] public AudioClip soundBPrepareFA, soundAttackFA;
    [HideInInspector] public bool isFallingObjectAttack { get; set; }
    [HideInInspector] public FallingProjectileBullet fallingAttackBullet;
    [HideInInspector] public LayerMask layerGround;
